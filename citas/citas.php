			...
			<tbody>
				<?php
					 ...
					 if ($horarios['paciente']<>''){
							 ...
							 echo"<td id='$id2' name='$paciente' button='true'><button type='button' class='btn btn-Rojo'><span class='glyphicon glyphicon-remove'></span> Cancelar Cita</button></td>";
					 }else{
							 echo"<td></td>";						 
							 echo"<td></td>";						 
						 }
					 ...
					 echo"<td id='id:$id''><select  class='form-control' id='id".$doct."' name='$id'><option>Por Definir</option>";					 
