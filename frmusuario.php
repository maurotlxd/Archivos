	...
	<nav class="navbar navbar-default barraAzul">
		<div class="container-fluid quitarPadding">
			<div class="navbar-header">
				...
				<a href="frmusuario.php" class="navbar-brand" style="color: white;">Bienvenido usuario
				<?php
...
<div class="jumbotron barraAzul">
 ...
 <div class="row">
 <div class="col-lg-8">
   <h2 style="color: white;"><i class="glyphicon glyphicon-home"></i>  Bienvenido al panel de Paciente</h2>
 </div>
